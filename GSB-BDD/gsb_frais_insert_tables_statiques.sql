...
('c10', 'Murillo', 'Raquel', 'Lisbonne', 'mux7g'),
('c20', 'Oliveira', 'Silene', 'Tokyo', 'ollg5'),
('c30', 'Cortés', 'Annibal', 'Rio', 'co8xd'),
('c40', 'Jimenez', 'Agata', 'Nairobi', 'jih3d'),
('c50', 'Ramos', 'Daniel', 'Denver', 'rahx6'),
('c60', 'Ramos', 'Agustin', 'Moscou', 'g4rad'),
('c70', 'Dragić', 'Mirko', 'Helsinki', '9daxd'),
('c80', 'Gaztambide', 'Mónica', 'Stockholm', 'ga1xd'),
('c90', 'Marquina', 'Sergio', 'Professeur', 'max2d');
-- --------------------------------------------------------
